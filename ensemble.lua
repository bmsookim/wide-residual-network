...
-- ensemble depths
ens_depth         = torch.Tensor({28, 28, 28, 28, 28, 28, 40, 40, 40, 40, 40, 40, 40})
ens_widen_factor  = torch.Tensor({10, 10, 10, 10, 10, 20, 10, 10, 10, 10, 10, 14, 14})
ens_nExperiment   = torch.Tensor({1,  2,  3,  4,  5,  1,  1,  2,  3,  4 , 5,  1,  2})

-- get ensemble numbers
opts.nEnsemble = ens_depth:size(1)
